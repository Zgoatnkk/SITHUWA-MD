...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'SHUN URUMA BOT',
  packname:  process.env.PACK_NAME || 'MADE BY NK455',
  
  botname:   process.env.BOT_NAME === undefined ? "SHUN URUMA-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'NK455' : process.env.OWNER_NAME,  
